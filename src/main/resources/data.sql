...
(JUNCTION_NAME, STATUS, VEHICLE_COUNT, CONGESTION_LEVEL, LATITUDE, LONGITUDE)
VALUES
('Shivajinagar Junction','GREEN',120,45.5,18.5308,73.8475),
('FC Road Junction','GREEN',150,40,18.5220,73.8550),
('JM Road Junction','RED',180,70,18.5255,73.8500),
('Camp Signal','GREEN',130,35,18.5018,73.8636),
('Swargate Signal','RED',250,90,18.4974,73.8501),
('Pune Station Signal','GREEN',170,50,18.5289,73.8742),
('Shaniwarwada Signal','RED',220,80,18.5204,73.8567),
('Deccan Signal','GREEN',160,45,18.5167,73.8562),
('Karve Road Signal','RED',190,75,18.5074,73.8077),
('Kothrud Signal','GREEN',140,38,18.5010,73.8000),
('Aundh Signal','RED',210,82,18.5590,73.8070),
('Baner Signal','GREEN',155,42,18.5679,73.7797),
('Wakad Signal','RED',240,88,18.5975,73.7898),
('Hinjewadi Signal','GREEN',175,48,18.5912,73.7389),
('Nigdi Signal','RED',200,78,18.6513,73.7706),
('Pimpri Signal','GREEN',165,44,18.6298,73.7997),
('Chinchwad Signal','RED',195,76,18.6270,73.7820),
('Yerawada Signal','GREEN',145,39,18.5510,73.8950),
('Kharadi Signal','RED',225,85,18.5519,73.9476),
('Viman Nagar Signal','GREEN',160,46,18.5679,73.9143),
('Magarpatta Signal','RED',230,87,18.5150,73.9250),
('Warje Signal','GREEN',135,36,18.4897,73.7980),
('Karve Nagar Signal','RED',185,72,18.4890,73.8210),
('Bibwewadi Signal','GREEN',150,40,18.4768,73.8660),
('Dhankawadi Signal','RED',210,83,18.4630,73.8520),
('Sinhagad Road Signal','GREEN',170,50,18.4700,73.8200),
('Market Yard Signal','RED',240,90,18.4870,73.8690),
('Hadapsar Signal','GREEN',180,52,18.5089,73.9260),
('Kondhwa Signal','RED',205,79,18.4730,73.8940),
('Wanowrie Signal','GREEN',150,41,18.4980,73.8970),
('Fatima Nagar Signal','RED',195,74,18.5070,73.8990),
('Pashan Signal','GREEN',140,35,18.5350,73.7980),
('Bavdhan Signal','RED',190,73,18.5200,73.7800),
('Balewadi Signal','GREEN',160,47,18.5760,73.7890),
('University Circle','RED',220,84,18.5390,73.8300),
('Model Colony Signal','GREEN',145,38,18.5340,73.8370),
('Nal Stop Signal','RED',200,80,18.5130,73.8330),
('Dandekar Bridge Signal','GREEN',155,42,18.5030,73.8420),
('Alka Talkies Signal','RED',180,69,18.5150,73.8490),
('Tilak Road Signal','GREEN',160,46,18.5080,73.8490),
('RTO Signal','RED',210,82,18.5310,73.8680),
('Bund Garden Signal','GREEN',170,49,18.5390,73.8820),
('Sangamwadi Signal','RED',225,86,18.5440,73.8680),
('Koregaon Park Signal','GREEN',150,40,18.5380,73.8920),
('Mundhwa Signal','RED',230,88,18.5330,73.9200),
('Phursungi Signal','GREEN',145,39,18.4790,73.9620),
('Bhosari Signal','RED',215,84,18.6210,73.8450),
('Alandi Road Signal','GREEN',165,44,18.6000,73.8680),
('Dighi Signal','RED',205,81,18.6080,73.8600),
('Lohegaon Signal','GREEN',155,42,18.5910,73.9100);
